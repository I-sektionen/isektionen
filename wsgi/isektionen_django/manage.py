...
if __name__ == "__main__":
    ...
    try:
        ...
        pass
    #os.chdir('isektionen_django/')  #this will make the python interpreter see isektionen_django.isektionen_django when running tests.
    os.environ.setdefault("DJANGO_SETTINGS_MODULE", "isektionen.settings")
